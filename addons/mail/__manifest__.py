...
Communicate with your colleagues/customers/guest within EagleERP.
...
from EagleERP itself, and that too with great possibilities. For example,
...
This can be used to easily create email-based workflows for many email-enabled EagleERP documents, such as:
----------------------------------------------------------------------------------------------------------
