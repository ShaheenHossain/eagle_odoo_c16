...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="Eagle database name (default: %default)", default='odoo')
    ...
    op.add_option("--port", dest="port", help="Eagle ERP port (default: %default)", default=8069, type=int)
