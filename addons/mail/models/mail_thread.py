...
class MailThread(models.AbstractModel):
    ...
    def message_post(self, *,
        ...
        if 'channel_ids' in kwargs:
            raise ValueError(_("Posting a message with channels as listeners is not supported since EagleERP 14.3+. Please update code accordingly."))
    ...
    def _notify_by_email_get_base_mail_values(self, message, additional_values=None):
        ...
        # SES SMTP may replace Message-Id and In-Reply-To refers an internal ID not stored in EagleERP)
